        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-primary">AI-Powered Business Communication</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Afterloop automatically detects tasks, decisions, and blockers in your team conversations. 
              Transform scattered work into organized action with AI that understands your workflow.
            </p>
