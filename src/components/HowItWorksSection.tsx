...
const steps = [
  {
    ...
    description:
      'Your team chats naturally while AI monitors for actionable statements like "I\'ll fix the onboarding bug by Friday"',
    example:
      '"I\'ll review the design mockups by Wednesday and get back to you."',
  },
  {
    icon: Brain,
    step: "02",
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-foreground">
            ...
            <span className="bg-gradient-to-b from-slate-50 to-purple-200 bg-clip-text text-transparent">
              Seconds
            </span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {steps.map((step, index) => (
            <Card
              key={index}
              className="p-8 bg-background/80 backdrop-blur-sm border-0 shadow-xl group hover:shadow-2xl transition-all duration-300">
